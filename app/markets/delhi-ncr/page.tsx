...
export const metadata: Metadata = {
  title: "Web Development & SEO Services in Delhi NCR | RankVRA",
  description:
    "Custom Next.js web development, SaaS applications, and commercial SEO for enterprises, startups, and B2B companies across Gurgaon, Noida, and Delhi NCR.",
  alternates: { canonical: "https://www.rankvra.com/markets/delhi-ncr" },
  openGraph: {
    title: "Web Development & SEO Services in Delhi NCR | RankVRA",
    description:
      "Custom Next.js web development, SaaS applications, and commercial SEO for enterprises across Gurgaon, Noida, and Delhi NCR.",
    url: "https://www.rankvra.com/markets/delhi-ncr",
    siteName: "RankVRA",
    locale: "en_IN",
    type: "website",
  },
...
const pageSchema = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.rankvra.com/markets/delhi-ncr#webpage",
      url: "https://www.rankvra.com/markets/delhi-ncr",
      name: "Web Development & SEO Services in Delhi NCR | RankVRA",
      description:
        "High-speed custom web development, corporate web applications, and commercial search systems for businesses in Delhi NCR.",
      isPartOf: {
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.rankvra.com/markets/delhi-ncr#breadcrumb",
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
        ...
        },
        {
          ...
          position: 3,
          name: "Delhi NCR",
          item: "https://www.rankvra.com/markets/delhi-ncr",
        },
      ],
    },
  ],
...
export default function DelhiNcrMarketPage() {
  return (
    <SiteShell>
      <script
        ...
        <section className="relative overflow-hidden border-b border-[#e2e8f0] bg-gradient-to-b from-white via-indigo-50/20 to-[#f8fafc] pt-12 pb-16 lg:pt-16 lg:pb-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <nav aria-label="Breadcrumbs" className="mb-6 flex items-center gap-2 text-xs font-medium text-[#64748b]">
              ...
              <ChevronRight size={12} className="text-[#94a3b8]" />
              <span className="text-[#4f46e5] font-semibold">Delhi NCR</span>
            </nav>
            ...
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50/80 px-3.5 py-1 text-xs font-bold uppercase tracking-wider text-indigo-700 mb-4">
                ...
                <span>Delhi NCR Commercial Hub</span>
              </div>
              <h1 className="text-3xl sm:text-5xl font-black tracking-tight text-[#0f172a] leading-tight">
                ...
                <span className="bg-gradient-to-r from-indigo-600 via-blue-600 to-teal-600 bg-clip-text text-transparent">
                  Delhi NCR Enterprises &amp; Startups.
                </span>
              </h1>
              <p className="mt-5 text-base sm:text-lg text-[#475569] leading-relaxed">
                RankVRA provides engineering-first web development, SaaS portals, and commercial search systems for enterprises and fast-growing businesses in Gurgaon (Cyber City, Golf Course Road), Noida (Tech Sectors), and Central Delhi.
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                >
                  Request a Free Delhi NCR Audit
                </Link>
                <Link
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="max-w-2xl mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#0f172a] mt-2">
                Engineering Digital Infrastructure for Modern NCR Businesses
              </h2>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="p-6 rounded-2xl border border-slate-200 bg-slate-50/50">
                ...
                <h3 className="text-base font-bold text-slate-900 mb-2">Corporate Storefronts</h3>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  High-trust websites designed for consulting firms, enterprise headquarters, and professional practices demanding clean visual credibility and fast load times.
                </p>
              </div>

              <div className="p-6 rounded-2xl border border-slate-200 bg-slate-50/50">
                <Code2 size={22} className="text-indigo-600 mb-3" />
                <h3 className="text-base font-bold text-slate-900 mb-2">B2B SaaS &amp; Client Portals</h3>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Interactive dashboards, authenticated partner areas, and custom web applications engineered with Next.js App Router and TypeScript.
                </p>
              </div>

              <div className="p-6 rounded-2xl border border-slate-200 bg-slate-50/50">
                <Zap size={22} className="text-indigo-600 mb-3" />
                <h3 className="text-base font-bold text-slate-900 mb-2">Commercial SEO &amp; Inbound Leads</h3>
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Topical search clustering and technical crawl optimization that capture corporate procurement managers and business decision-makers.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-[32px] bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#0f172a] p-8 sm:p-14 text-white shadow-xl relative overflow-hidden">
              <div className="relative z-10 max-w-2xl">
                ...
                <h2 className="mt-3 text-2xl sm:text-4xl font-extrabold tracking-tight">
                  Upgrade your company&apos;s digital infrastructure
                </h2>
                <p className="mt-4 text-sm sm:text-base text-[#cbd5e1] leading-relaxed">
                  Direct architectural discovery with Founder Naveen Panchal.
                </p>
                <div className="mt-8 flex flex-wrap gap-4">
                  ...
                  <a
                    href="https://wa.me/917297875798?text=Hi%20Naveen,%20I'm%20based%20in%20Delhi%20NCR%20and%20would%20like%20to%20discuss%20a%20website%20project."
                    target="_blank"

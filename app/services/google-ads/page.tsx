        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-base sm:text-lg text-[#475569] leading-8">
              When a buyer in your industry types a commercial search query into Google, they are looking to take action today. We engineer tightly controlled Google Search campaigns that place your business in front of high-intent searchers and block irrelevant clicks with continuous negative keyword management.
            </p>
